...
df = pd.DataFrame(list(data), columns=('TÊN THIẾT BỊ','TÊN CŨ','LOẠI THIẾT BỊ','NHÀ MÁY','VỊ TRÍ','MODEL','TRẠNG THÁI','HỆ THỐNG','MÔ TẢ','SỐ SERI', 'THỜI GIAN BẮT ĐẦU','THỜI GIAN KẾT THÚC','THỜI GIAN CẬP NHẬT','NGƯỜI CẬP NHẬT','ẢNH'), index=range(1,len(df)+1))
print (df)
...
writer = pd.ExcelWriter('C:\\ABC\\public\\mcex\\'+ 'DANHSACHMAY_' +current_time +'.xlsx', engine='xlsxwriter')
